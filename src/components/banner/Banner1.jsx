        ...
        <div className='py-12 sm:py-0 realtive'>
            <div className="container min-h-[620px] flex items-center">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 place-items-center ">   
                 ...
                 <h1 className='text-4xl font-semibold' data-aos="fade-up"   data-aos-delay="300">GET READY TO ENJ0Y VR <span className='bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary'>GAMES WITH OUR PLATFORM</span></h1>
                ...
                <div className='order-1 sm:order-2'> 
                        <img src={banner} alt="" className='relative w-full max-w-[400px]' data-aos="fade-up"   data-aos-delay="300"/>
                    </div>
                   </div>
                </div>
            </div>
